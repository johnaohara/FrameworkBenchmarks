...
COPY pgclient-reactiverse-thread-local/pom.xml pgclient-reactiverse-custom-pool/pom.xml
...
COPY pgclient-reactiverse-thread-local/src pgclient-reactiverse-custom-pool/src
RUN mvn package -q -pl pgclient-reactiverse-thread-local -am

FROM openjdk:11.0.6-jdk-slim
WORKDIR /quarkus
COPY --from=maven /quarkus/pgclient-reactiverse-thread-local/target/lib lib
COPY --from=maven /quarkus/pgclient-reactiverse-thread-local/targetpgclient-reactiverse-thread-local-1.0-SNAPSHOT-runner.jar app.jar
